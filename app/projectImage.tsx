...
const ProjectList = memo((projects: any) => (
  <SwiperSlide>
    <div className="flex items-start gap-4">
      ...
      <article className="group relative flex flex-col items-start inline-block">
            ...
            <article className="group relative flex flex-col items-start inline-block">
              <h2 className="text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
                ...
                {/* <a href="/articles/crafting-a-design-system-for-a-multiplanetary-future"> 
                 ...
                 </a> */}<span className="relative z-10">{projects.title}</span>
              </h2>
              <time
                className="relative z-10 order-first mb-3 flex items-center text-sm text-zinc-400 dark:text-zinc-500 pl-3.5"
                dateTime="2022-09-05"
